...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
    ...
    //Write a native query to get cart items for specific cart state and product name (String cart_state - the type of enums is String)
    ...
    List<CartItem> retrieveCartItemsByStateAndName(@Param("cartState") String cartState, @Param("name") String name);
    ...
    List<CartItem> retrieveCartItemsByCartStateWithoutDiscount(CartState cartState);
    ...
    List<CartItem> retrieveCartItemByCartStateAndDiscountType(@Param("cartState") CartState cartState, @Param("discountType") DiscountType discountType);
}
